  ...
  return (
    <ImageBackground style={AppStyles.imageContainer} source={background}>
      <KeyboardAvoidingView 
        ...
        <Text style={[AppStyles.lightText, AppStyles.header]}>Đăng Nhập</Text>
        ...
        <View style={[AppStyles.rowContainer, AppStyles.topMargin]}>
          <Text style={AppStyles.lightText}>Chưa có tài khoản? </Text>
          <InlineTextButton text="Sign Up" onPress={() => navigation.navigate("SignUp")} />
        </View>
        <View style={[AppStyles.rowContainer, AppStyles.bottomMargin]}>
          <Text style={AppStyles.lightText}>Quên mật khẩu? </Text>
          <InlineTextButton text="Reset" onPress={() => navigation.navigate("ResetPassword")} />
        </View>
        <Button title="Đăng Nhập" onPress={login} color="#f7b267" />
      </KeyboardAvoidingView>
    </ImageBackground>
  );
}
